...
F03 | Menadžment | Registrirane knjižnice kao i registrirani korisnici imaju mogućnost dodavanja knjiga pri ćemu dodaju sliku knjige, naziv knjige, kratki opis, žanr, prosječno vrijeme čitanja te oznaku Scriptify Aproved. Knjižnice kao i korisnici mogu naknadno mijenjati podatke o pojedinoj knjizi te se sve promjene automatski pohranjuju i ažuriraju u bazi podataka. | ...
F04 | Pregled knjiga | Nakon što se korisnik logira u sustav, vidi popis svih knjiga koje su u sustavu, bilo da su to knjige koje je dodao drugi korisnik ili neka knjžnica. Korisnik može kliknuti na bilo koju knjigu i vidjeti pregled svih informacija o toj knjizi koju želi posuditi. |...
F05 | Upravljanje knjigama | Knjižnice mogu vidjeti popis knjiga koje su trenutno posuđene te korisnike koji su ih posudili. | ...
F06 | Posudba knjige | Omogućuje korisnicima da u popisu svih knjiga kliknu na gumb posudi pokraj željene knjige. Nakon što se klikne na gumb posudi, otvara se opis knjige koju posuđuje. | ...
...
F09 |Scriptify Aproved program | Korisnici koji imaju Scriptify wallet, mogu platiti one-time cijenu za posebne ponude knjiga, knjige koje tek dolaze ili koje su tek najavljane. Knjižnice imaju opciju za svaku knjigu staviti Scriptify Aprooved tag gdje u tom slučaju samo korisnici iz ovog programa mogu čitati knjigu. Za druge korisnike koji nisu platili knjiga se neće pojaviti.
